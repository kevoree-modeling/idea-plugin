...
public class MetaModelSemanticFromImpl extends ASTWrapperPsiElement implements MetaModelSemanticFrom {

  public MetaModelSemanticFromImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MetaModelVisitor visitor) {
    visitor.visitSemanticFrom(this);
  }
