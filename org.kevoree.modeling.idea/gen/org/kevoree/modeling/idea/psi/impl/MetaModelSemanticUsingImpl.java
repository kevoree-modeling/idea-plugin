...
public class MetaModelSemanticUsingImpl extends ASTWrapperPsiElement implements MetaModelSemanticUsing {

  public MetaModelSemanticUsingImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MetaModelVisitor visitor) {
    visitor.visitSemanticUsing(this);
  }
